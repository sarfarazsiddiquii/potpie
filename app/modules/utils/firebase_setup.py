    ...
    def firebase_init():
        ...
        try:
            ...
            if os.path.exists(base64_file_path):
                ...
                logging.error("Neither Firebase service account file 'firebase_service_account.txt' nor 'firebase_service_account.json' found.")
                raise FileNotFoundError("Neither Firebase service account file 'firebase_service_account.txt' nor 'firebase_service_account.json' found.")
