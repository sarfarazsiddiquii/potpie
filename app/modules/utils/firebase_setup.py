...
class FirebaseSetup:
    ...
    def firebase_init():
        ...
        parent_directory = os.path.abspath(os.path.join(current_file_path, *(['..'] * 3)))
        cred = None
        if service_account_base64:
            try:
                ...
                cred = credentials.Certificate(os.path.join(parent_directory, "firebase_service_account.json"))
